...
Also, the labels used while training the deep clustering are updated after some iterations based on the model's own outputs, updating the target distribution. For this reason the model is called self supervised.<br/>
