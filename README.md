...
The encoder used in the deep clustering model trained with the MNIST dataset was the one that was trained with the same dataset in the project from my [autoencoder](https://github.com/luizamarnet/autoencoder) respository. The output of this encoder is an array of size 10x1.<br/>
